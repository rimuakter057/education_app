...
class CustomExpansionTile extends StatelessWidget {
  const CustomExpansionTile({
    super.key, this.titleIcon, this.titleText, this.containerText, this.trailingIcon, this.titleIconColor,
  });
    ...
    return ExpansionTile(
      title: Row(
        ...
        titleIcon??  Icon(
          ...
          Expanded(
            child: CustomText(
              text:titleText?? "Introduction to",
